...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\H-Field\h-field (f=8.3) [1]
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\H-Field\h-field (f=8.3) [2]
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Surface Current\surface current (f=8.3) [1]
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Surface Current\surface current (f=8.3) [2]
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\E-Field\e-field (f=8.3) [1]
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\E-Field\e-field (f=8.3) [2]
